---
title: AI Import Template
---

# Resume Studio — AI Import Template (v1)

> This is the canonical copy of the template Resume Studio's **AI-assisted
> import** hands to your LLM. The app bundles its own copy (offline-ready); this
> page exists so you can read or link it directly. Attach it to your LLM
> together with your PDF/Word CV.
